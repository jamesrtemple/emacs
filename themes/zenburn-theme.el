...
;;;;; org-mode
   ...
   `(org-level-1 ((t (:height 1.2 :foreground ,zenburn-orange))))
   `(org-level-2 ((t (:height 1.1 :foreground ,zenburn-green+4))))
   ...
   `(org-tag ((t (:foreground ,zenburn-bg+2))))
